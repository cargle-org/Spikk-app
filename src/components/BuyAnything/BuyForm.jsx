...
function BuyForm() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      item_name: Yup.string().label("Item Name").required(),
      unit_amount: Yup.number().label("Amount").required(),
      comment: Yup.string().label("Comment"),
      quantity: Yup.number().label("Quantity").required(),
      item_image: Yup.string().label("Image"),
    }),
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="form-input">
          <InputWrapper>
            ...
            {formik.touched.item_name && formik.errors.item_name && <span className="errorText">{formik.errors.item_name}</span>}
          </InputWrapper>
          <InputWrapper>
            <div
              className={formik.touched.item_image && formik.errors.item_image ? "input-group error" : " input-group"}
            ...
            >
              ...
              />
              <label htmlFor="item_image" className="file-label">
                {formik?.values?.item_image !== "image" ? formik.values?.item_image : "Attach an Image(optional)"}{" "}
              </label>
              <label htmlFor="item_image">
                <img src={uploader} alt="icon" />
              </label>
            </div>
            {formik.touched.item_image && formik.errors.item_image && <span className="errorText">Please input a valid image type</span>}
          </InputWrapper>
          <InputWrapper>
            <div className="input-group">
            ...
            {formik.touched.unit_amount && formik.errors.unit_amount && <span className="errorText">{formik.errors.unit_amount}</span>}
          </InputWrapper>
          <InputWrapper>
            <div className="input-group">
              <input
            ...
            {formik.touched.quantity && formik.errors.quantity && <span className="errorText">{formik.errors.quantity}</span>}
          </InputWrapper>
          <InputWrapper>
            <div className="input-group">
              <input
            ...
            {formik.touched.comment && formik.errors.comment && <span className="errorText">{formik.errors.comment}</span>}
          </InputWrapper>
        </div>
